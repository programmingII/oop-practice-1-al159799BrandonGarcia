...
if((A % 10 == B % 10)||(A % 10 == C % 10)||(B % 10 == C % 10))//condicional if que se cumple si el reciduo de las divisiones de las variables es igual
System.out.println("El resultado es: true");//print que se imprime si el if se cumple

else//else que se ejecuta si no se cumple la condicion del if
System.out.println("El resultado es: false");//print que se imprime si no se cumplio la if 
}
}