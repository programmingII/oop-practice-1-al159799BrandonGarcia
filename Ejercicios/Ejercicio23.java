...
String conversion2 = Integer.toString(conversion1,16);//declaracion de una variable string para recibir el valor de una variable anterior y convertirla a hexadecimal

System.out.println("El numero hexadecimal es: "+ conversion2);//print para motrar el resultado de la conversion a hexadecimal
